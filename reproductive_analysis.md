Análise de Performance de Desenvolvimento em Proles de Tityus stigmurus
================
Welton Dionisio
2025-06-19
...
Nessa pesquisa eu investiguei se havia diferença na performance de
desenvolvimento em proles subsequentes de fêmeas do escorpião amarelo,
*Tityus stigmurus*.

Embora os filhotes sejam clones da mãe, que se reproduz assexuadamente,
é esperado que mães mais velhas produzam menor número de filhotes ou ao
menos filhotes com um desenvolvimento prejudicado.

Para avaliar isso, foram comparadas duas ninhadas consecutivas (primeira
e segunda) de um amostra de fêmeas dessa espécie criadas em laboratório
sob as mesmas condições de criação. O desenvolvimento dos filhotes foi
acompanhado até que uma quantidade atingisse a fase adulta. Durante esse
tempo, foram mensuradas características que apontam o “desempenho” das
primeiras e segundas ninhadas.
